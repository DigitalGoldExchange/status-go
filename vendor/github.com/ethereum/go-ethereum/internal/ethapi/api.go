...
import (
	...
	pubethapi "github.com/ethereum/go-ethereum/ethapi"
)
...
func NewPrivateAccountAPI(b Backend, nonceLock *AddrLocker) *PrivateAccountAPI {
	return &PrivateAccountAPI{
		PrivateAccountAPI: *pubethapi.NewPrivateAccountAPI(b.AccountManager()),
		am:                b.AccountManager(),
		nonceLock:         nonceLock,
		b:                 b,
	}
...
func (s *PublicTransactionPoolAPI) Sign(addr common.Address, data hexutil.Bytes) (hexutil.Bytes, error) {
	...
	signature, err := wallet.SignHash(account, pubethapi.SignHash(data))
	if err == nil {
